...
public class CardGame implements GameInterface {
	...
	//Majority of code is reused from the previous iteration of the card game
	...
	public static void initialiseGame() throws Exception {
		System.out.println("The aim of this game is to pick an ace out of a pack of cards.\n");
